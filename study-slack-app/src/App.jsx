...
[문장 선정 기준]
1. 의미가 비교적 명확한 문장
2. Yeah/Okay/Right 같은 단순 맞장구가 아닌 의견·질문·설명·경험이 담긴 문장
3. 다음 스터디에서도 비슷한 상황에 재사용할 수 있는 문장
4. 더 자연스럽고 풍부한 표현으로 바꿀 여지가 있는 문장
5. 이 참가자의 반복적인 말하기 습관이 드러나는 문장
...
export default function App() {
  ...
  const sendToSlack = async () => {
    ...
    try {
      ...
      if (results.common) {
        await postSlack({ attachments: [{ color: "#F5A623", text: results.common, mrkdwn_in: ["text"] }] });
      }
