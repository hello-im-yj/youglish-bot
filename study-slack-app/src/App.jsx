...
const buildEnglishPromptForOne = (name, speakerLines) => `아래 ${name}의 발화에서 영어 교정이 필요한 문장을 최대 5개 골라 다음 형식으로만 출력하세요.
...
각 항목 사이 빈 줄 필수. 원문·추천은 반드시 \`인라인 코드\` 처리.
영어 발화가 없으면 "(영어 발화 없음)" 한 줄만 출력.

[선별 기준] 반복 오류 > 오해 유발 > 문법(시제·관사·전치사) > 콜로케이션 > 어휘 다양성 (사소한 오류 제외)
